...
class UserObserver:
    def notify(self, message):
        # Implement notification logic, e.g., sending email notifications
        pass
...
notification_system.register(user_observer)
...
def post():
    ...
    if form.validate_on_submit():
        ...
        # Notify observers about new post
        notification_system.notify_all("New post created by {}".format(g.user.username))
...
if __name__ == '__main__':
    ...
    try:
        models.User.create_user(
            username='aninda20',
            email='anindamandal10@gmail.com',
            password='password',
            admin=True
        )
    except ValueError:
